...
```
    ...
    Old packages: 'BiocParallel', 'bslib', 'cachem', 'curl', 'DelayedArray', 'DT',
      'emmeans', 'evaluate', 'jsonlite', 'knitr', 'markdown', 'MatrixGenerics',
      'matrixStats', 'mvtnorm', 'RcppArmadillo', 'reticulate', 'rlang',
      'rmarkdown', 'sass', 'sp', 'SummarizedExperiment', 'sys', 'tidycensus',
      'usethis'
...
```
    ...
    Info: Working in directory C:/Users/parsa/OneDrive/Desktop/Class 13/Class 13
...
Different gene sets and database
